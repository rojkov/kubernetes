...
type configMutatorsFunc func(*kubeadmapi.InitConfiguration, *kubeadmapi.CertConfig) error
...
func (k *KubeadmCert) GetConfig(ic *kubeadmapi.InitConfiguration) (*kubeadmapi.CertConfig, error) {
...
func makeAltNamesMutator(f func(*kubeadmapi.InitConfiguration) (*certutil.AltNames, error)) configMutatorsFunc {
	return func(mc *kubeadmapi.InitConfiguration, cc *kubeadmapi.CertConfig) error {
		altNames, err := f(mc)
		if err != nil {
			return err
		}

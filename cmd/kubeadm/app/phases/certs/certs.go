...
// existing and the expected certificate equals. If they do; kubeadm will just skip writing the file as it's up-to-date,
// otherwise this function returns an error.
func writeCertificateFilesIfNotExist(pkiDir string, baseName string, signingCert *x509.Certificate, cert *x509.Certificate, key crypto.Signer, cfg *kubeadmapi.CertConfig) error {
...
func validateCertificateWithConfig(cert *x509.Certificate, baseName string, cfg *kubeadmapi.CertConfig) error {

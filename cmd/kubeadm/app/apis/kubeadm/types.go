...
func (a PublicKeyAlgorithm) String() string {
	return []string{"RSA", "ECDSA"}[a]
}

// ConvertToPublicKeyAlgorithm converts from x509 to kubeadm PublicKeyAlgorithm
func ConvertToPublicKeyAlgorithm(algo x509.PublicKeyAlgorithm) PublicKeyAlgorithm {
	if algo == x509.ECDSA {
		return ECDSA
	}

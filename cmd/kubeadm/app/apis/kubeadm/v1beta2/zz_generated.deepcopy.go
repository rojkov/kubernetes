...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PublicKeyAlgorithm) DeepCopyInto(out *PublicKeyAlgorithm) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PublicKeyAlgorithm.
func (in *PublicKeyAlgorithm) DeepCopy() *PublicKeyAlgorithm {
	if in == nil {
		return nil
	}
	out := new(PublicKeyAlgorithm)

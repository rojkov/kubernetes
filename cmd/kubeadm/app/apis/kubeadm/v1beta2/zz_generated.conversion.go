...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*kubeadm.PublicKeyAlgorithm)(nil), (*PublicKeyAlgorithm)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_kubeadm_PublicKeyAlgorithm_To_v1beta2_PublicKeyAlgorithm(a.(*kubeadm.PublicKeyAlgorithm), b.(*PublicKeyAlgorithm), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*PublicKeyAlgorithm)(nil), (*kubeadm.PublicKeyAlgorithm)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_PublicKeyAlgorithm_To_kubeadm_PublicKeyAlgorithm(a.(*PublicKeyAlgorithm), b.(*kubeadm.PublicKeyAlgorithm), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1beta2_InitConfiguration_To_kubeadm_InitConfiguration(in *InitConfiguration, out *kubeadm.InitConfiguration, s conversion.Scope) error {
	...
	// WARNING: in.PublicKeyAlgorithm requires manual conversion: inconvertible types (*k8s.io/kubernetes/cmd/kubeadm/app/apis/kubeadm/v1beta2.PublicKeyAlgorithm vs k8s.io/kubernetes/cmd/kubeadm/app/apis/kubeadm.PublicKeyAlgorithm)
	return nil
}
...
func autoConvert_kubeadm_InitConfiguration_To_v1beta2_InitConfiguration(in *kubeadm.InitConfiguration, out *InitConfiguration, s conversion.Scope) error {
	...
	out.CertificateKey = in.CertificateKey
	// WARNING: in.PublicKeyAlgorithm requires manual conversion: inconvertible types (k8s.io/kubernetes/cmd/kubeadm/app/apis/kubeadm.PublicKeyAlgorithm vs *k8s.io/kubernetes/cmd/kubeadm/app/apis/kubeadm/v1beta2.PublicKeyAlgorithm)
	return nil
}
...
func autoConvert_v1beta2_PublicKeyAlgorithm_To_kubeadm_PublicKeyAlgorithm(in *PublicKeyAlgorithm, out *kubeadm.PublicKeyAlgorithm, s conversion.Scope) error {
	// WARNING: in.PublicKeyAlgorithm requires manual conversion: does not exist in peer-type
	return nil
}

func autoConvert_kubeadm_PublicKeyAlgorithm_To_v1beta2_PublicKeyAlgorithm(in *kubeadm.PublicKeyAlgorithm, out *PublicKeyAlgorithm, s conversion.Scope) error {
	// FIXME: Type kubeadm.PublicKeyAlgorithm is unsupported.
	return nil
}

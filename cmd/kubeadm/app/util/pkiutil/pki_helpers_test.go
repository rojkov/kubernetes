...
func TestNewCertificateAuthority(t *testing.T) {
	cert, key, err := NewCertificateAuthority(&kubeadmapi.CertConfig{
...
func TestHasServerAuth(t *testing.T) {
	caCert, caKey, _ := NewCertificateAuthority(&kubeadmapi.CertConfig{Config: certutil.Config{CommonName: "kubernetes"}})
...
func TestTryLoadCertAndKeyFromDisk(t *testing.T) {
	...
	caCert, caKey, err := NewCertificateAuthority(&kubeadmapi.CertConfig{
		Config: certutil.Config{CommonName: "kubernetes"},
	})
	if err != nil {
		t.Errorf(
...
func TestTryLoadCertFromDisk(t *testing.T) {
	...
	caCert, _, err := NewCertificateAuthority(&kubeadmapi.CertConfig{
		Config: certutil.Config{CommonName: "kubernetes"},
	})
	if err != nil {
		t.Errorf(
